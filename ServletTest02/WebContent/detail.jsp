...
<table>
	...
	<tr>
		<td colspan="2">
		<input type="submit" value="수정" onclick="location.href='update.ad?num=${dto.num}'">
		<input type="button" value="삭제" onclick="location.href='delete.ad?num=${dto.num}'"> <!-- del()이라는 함수를 부른다. -->
